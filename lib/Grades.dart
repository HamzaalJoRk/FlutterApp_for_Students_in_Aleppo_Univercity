              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      height: size.height / 1.8 * 0.1214285714285 * 0.65 * 2.1 * results[0]['data']['grades'][1]['course_year_related'].length,
                      child: ListView.builder(
                        itemCount: results[0]['data']['grades'].length,
                        itemBuilder: (BuildContext context, int index) {
                          final grade = results[0]['data']['grades'][index];
                          final isEvenRow = index % 2 == 0;
                          final cardColor = isEvenRow ? HexColor("#D6D3E5") : Colors.white ;
                          totalGrade = grade['pr_grade'] + grade['th_grade'];
                          totalGrades += totalGrade;
                          totalSubjects++;
                          if ( grade['cource_chapter'] == "1" && grade['course_year_related'] == '$years') {
                            if (totalGrade < 60) {
                            ...
                            if(numFilledCourses.length > 4){
                              ...
                              color: totalGrade < 60 ? Colors.red[200] : cardColor,
                              child: ListTile(
                                title: Row(
                                  children: [
                                    Expanded(
                                      flex: 1,
                                      child: Text(totalGrade.toString(),
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            color: HexColor("#475071")
                                        ),
                                    ...
                                    Expanded(
                                      flex: 1,
                                      child: Text(grade['th_grade'].toString(),
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            color: HexColor("#475071")
                                        ),
                                    ...
                                    Expanded(
                                      flex: 1,
                                      child: Text(grade['pr_grade'].toString(),
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            color: HexColor("#475071")
                                        ),
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      height: size.height / 1.8 * 0.1214285714285 * 0.65 * 2 * results[0]['data']['grades'][0]['course_year_related'].length,
                      child: ListView.builder(
                        itemCount: results[0]['data']['grades'].length,
                        itemBuilder: (BuildContext context, int index) {
                          final grade = results[0]['data']['grades'][index];
                          ...
                          totalGrade = grade['pr_grade'] + grade['th_grade'];
                            totalGrades += totalGrade;
                            totalSubjects++;
                          if ( grade['cource_chapter'] == "2" && grade['course_year_related'] == '$years') {
                            if (totalGrade < 60) {
                              numFilledCourses.add(grade['course_name']);
                            }
                            if(numFilledCourses.length > 4){
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text((results[0]['data']['grades'][0]['course_year_related']),
                                      style: TextStyle(
                                        color: HexColor("#475071"),
                                        fontWeight: FontWeight.w500,
                                      ),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 3,
                                child: Text('Num Of Courses Passed:',
                                  style: TextStyle(
                                    color: HexColor("#475071"),
                                    fontWeight: FontWeight.w500,
                                  ),
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(((results[0]['data']['grades'][0]['course_year_related'].length)-numFilledCourses.length).toString(),
                                      style: TextStyle(
                                        color: HexColor("#475071"),
                                        fontWeight: FontWeight.w500,
                                      ),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 3,
                                child: Text('Num Of Failed Courses :',
                                  style: TextStyle(
                                    color: HexColor("#475071"),
                                    fontWeight: FontWeight.w500,
                                  ),
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(numFilledCourses.length.toString(),
                                      style: TextStyle(
                                        color: HexColor("#475071"),
                                        fontWeight: FontWeight.w500,
                                      ),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 3,
                                child: Text('Full Num Of Courses:',
                                  style: TextStyle(
                                    color: HexColor("#475071"),
                                    fontWeight: FontWeight.w500,
                                  ),
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text((results[0]['data']['grades'][0]['course_year_related'].length).toString(),
                                      style: TextStyle(
                                        color: HexColor("#475071"),
                                        fontWeight: FontWeight.w500,
                                      ),
